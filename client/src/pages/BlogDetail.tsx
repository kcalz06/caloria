  ...
  if (!post) {
    return (
      <div className="container mx-auto px-4 py-8 text-center">
        ...
        <Link href="/">
          <a className="inline-block mt-4 px-4 py-2 bg-primary text-primary-foreground border-2 border-primary-border text-xs hover-elevate active-elevate-2">
            back to timeline
          </a>
        </Link>
      </div>
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-3xl mx-auto">
        <Link href="/">
          <a className="inline-flex items-center gap-2 mb-8 px-4 py-2 border-2 border-border text-xs hover-elevate active-elevate-2" data-testid="button-back">
